...
public interface JNCryptor {
     ...
     *
     * @param password password to use for PBKDF, can be <code>null</code> in which case
     ...
     *
     * @param ciphertext data to decrypt. Must be in the format described at <a
     *                   href="https://github.com/rnapier/RNCryptor/wiki/Data-Format"
     *                   >https://github.com/rnapier/RNCryptor/wiki/Data-Format</a>
     * @param password   password to use for the decryption. A <code>null</code> value or
     ...
     *                   an empty char array are considered equal (and are both valid
     *                   values).
     * @param settings   customized settings such as number of iterations required. If
     ...
     * @param password  password to use for the encryption. A <code>null</code> value or
     *                  an empty char array are considered equal (and are both valid
     *                  values).
